...
summon minecraft:item ~ ~ ~ {Tags:["Petrified_Heart"],Glowing:1b,PickupDelay:1,Item:{id:"minecraft:heart_of_the_sea",Count:1b,tag:{CustomModelData:1,lnc:1,display:{Name:'{"translate":"apolloparrot.deathsworn.petrified_heart","color":"#F01E67","bold":false,"italic":false}'}}}}
