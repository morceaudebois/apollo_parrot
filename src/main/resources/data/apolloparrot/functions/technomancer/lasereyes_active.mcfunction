...
execute unless block ~ ~ ~ air unless block ~ ~ ~ #apolloparrot:unbreakable run scoreboard players set #lasers Raycast_Hit 1
...
particle minecraft:dust 1.0 0.0 0.0 0.5 ^-0.2 ^ ^ 0 0 0 0 1 force @a
execute if score #lasers Raycast_Hit matches 0 positioned ^ ^ ^1 if entity @p[distance=..150] run function apolloparrot:technomancer/lasereyes_active
